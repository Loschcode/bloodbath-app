...
export default {
  ...
  watch: {
    /**
     * Once marketCoin has a value we subscribe to the channel if possible
     */
    marketCoin (newValue, oldValue) {
      if (newValue && !oldValue) {
        this.$store.dispatch('subscribeMarketCoinChannel', { id: newValue.id })
      }
    }
  },
